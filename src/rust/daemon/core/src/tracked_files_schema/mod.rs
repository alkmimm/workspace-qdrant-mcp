...
pub use operations::{
    ...
    insert_tracked_file, is_incremental, lookup_tracked_file, lookup_tracked_files_holding_branch,
    lookup_watch_folder, other_generation_exists, remove_branch_from_tracked_file, set_incremental,
    update_tracked_file,
};
